                  ...
                  <div className="pt-4 mt-4 border-t border-gray-200">
                    <div className="flex items-center px-4 py-3">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="text-sm font-medium text-gray-500">{getRoleDisplayName(user.role)}</div>
                    ...
                    <div className="mt-3 space-y-2">
                      ...
                      <button
                        ...
                        className="w-full mt-2 flex items-center justify-center px-4 py-3 border border-transparent rounded-lg shadow-sm text-base font-medium text-white bg-red-600 hover:bg-red-700 transition-colors"
                      >
